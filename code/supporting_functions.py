...
# 21/04/2018 RL new function, copied from update map below
def rock_located(Rover):
...
#     # to confirm whether detections are real
       is_sample_located = False #RL 21/04/2018 changed from 0 to TRUE
       if rock_world_pos[0].any():
            ...
            for idx in range(len(Rover.samples_pos[0])):
                   ...
                   if np.min(rock_sample_dists) < 3:
                        is_sample_located = True
       return is_sample_located


def rock_located1(Rover):

    is_sample_located = False #RL 21/04/2018 changed from 0 to TRUE
    print("rock_located1: {}".format(Rover.sample_dists))
    if Rover.sample_dists is not None:
        if Rover.sample_dists< 3:
            is_sample_located=True
    return is_sample_located
